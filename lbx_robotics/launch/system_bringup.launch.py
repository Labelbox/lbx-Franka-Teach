...
Usage:
  ...
  ros2 launch lbx_robotics system_bringup.launch.py enable_recording:=true
...
def generate_launch_description():
    ...
    # Get package paths
    lbx_robotics_share = get_package_share_directory('lbx_robotics')
    
    # Configuration files
    franka_control_config = os.path.join(
        lbx_robotics_share,
        'configs',
        'control',
    ...
    rviz_node = Node(
        ...
        executable='rviz2',
        name='rviz',
        arguments=['-d', os.path.join(lbx_robotics_share, 'configs', 'rviz', 'franka_vr_control.rviz')],
